...
// sync up with
// https://github.com/WebAssembly/wasi-webgpu/blob/main/wit/wasi-webgpu.wit#L136 Error
...
// sync up with
// https://github.com/WebAssembly/wasi-webgpu/blob/main/wit/wasi-webgpu.wit#L27
...
// sync up with
// https://github.com/WebAssembly/wasi-webgpu/blob/main/wit/wasi-webgpu.wit#L75
...
/* Definition of 'wasi_webgpu.h' structs in WASM app format (using offset) */

typedef wasi_webgpu_error (*LOAD)(void *, graph_builder_array *, graph_encoding,
                              execution_target, graph *);
typedef wasi_webgpu_error (*LOAD_BY_NAME)(void *, const char *, uint32_t, graph *);
typedef wasi_webgpu_error (*LOAD_BY_NAME_WITH_CONFIG)(void *, const char *,
                                                  uint32_t, void *, uint32_t,
                                                  graph *);
typedef wasi_webgpu_error (*INIT_EXECUTION_CONTEXT)(void *, graph,
                                                graph_execution_context *);
typedef wasi_webgpu_error (*SET_INPUT)(void *, graph_execution_context, uint32_t,
                                   tensor *);
typedef wasi_webgpu_error (*COMPUTE)(void *, graph_execution_context);
typedef wasi_webgpu_error (*GET_OUTPUT)(void *, graph_execution_context, uint32_t,
...
void
wasi_webgpu_dump_tensor_dimension(tensor_dimensions *dim, int32_t output_len,
                              char *output);
