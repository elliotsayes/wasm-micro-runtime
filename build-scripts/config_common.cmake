...
if (WAMR_BUILD_WASI_WEBGPU EQUAL 1)
  message ("     WASI-WEBGPU enabled")
  add_definitions (-DWASM_ENABLE_WASI_WEBGPU=1)
  # Variant backends
  if (NOT WAMR_BUILD_WASI_WEBGPU_WGPU EQUAL 1)
    message (FATAL_ERROR "   Need to select a backend for WASI-WEBGPU")
  endif ()

  if (WAMR_BUILD_WASI_WEBGPU_WGPU EQUAL 1)
    message ("     WASI-WEBGPU: backend wgpu enabled")
    add_definitions (-DWASM_ENABLE_WASI_WEBGPU_WGPU)
  endif ()
endif ()
